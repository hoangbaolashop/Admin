...
import { uploadImg, uploadImgMultiple } from '../../../services/uploadAPI'
...
const Create = (props) => {
    ...
    const {
        openCreateSP, setOpenCreateSP, fetchListSP
    } = props
    ...
    const handleCreateSP = async (values) => {
        ...
        const hinhAnhSlider = imageUrls.map(url => url.split('/').pop());
        console.log("Image: ", hinhAnh);
        console.log("ImageSlider: ", hinhAnhSlider);
        ...
        setIsSubmit(true)
        const res = await createProduct(TenSP, IdHangSX, IdLoaiSP, sizes, hinhAnh, hinhAnhSlider, MoTa, MoTaChiTiet, soGiamGia, urlYoutube)
    ...
    console.log("anh chinh:", imageUrl);
